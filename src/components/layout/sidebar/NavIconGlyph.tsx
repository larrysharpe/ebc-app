...
export function NavIconGlyph({ icon }: { icon: NavIcon }) {
  ...
  switch (icon) {
    ...
    case 'megaphone':
      return (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M11 5L6 9H3v6h3l5 4V5zm5.5 2.5a4.5 4.5 0 010 9" />
        </svg>
      );
    case 'share':
      return (
    ...
    case 'shield':
      return (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.617L12 22l9-1.383a12.02 12.02 0 00-2.382-9.632z" />
        </svg>
      );
    case 'building':
      return (
